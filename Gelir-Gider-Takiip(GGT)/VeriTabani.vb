...
Module VeriTabani
    ...
    Function Baglan() As OleDbConnection
        Dim baglanti = New OleDbConnection("Provider=Microsoft.Jet.OLEDB.4.0; Data Source=" & Application.StartupPath & "/GelirGiderTakip.mdb")
        baglanti.Open()
        Return baglanti
    End Function
    ...
    Function dsGelir(sql As String) As DataSet
        Dim baglanti As OleDbConnection = Baglan()
        Dim cmd = New OleDbCommand
        cmd.Connection = baglanti
        cmd.CommandText = sql
