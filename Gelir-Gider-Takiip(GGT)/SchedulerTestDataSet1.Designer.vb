...
Partial Public Class SchedulerTestDataSet
    ...
    Private Sub InitClass()
        ...
        Me.Prefix = ""
        Me.Namespace = "http://tempuri.org/SchedulerTestDataSet1.xsd"
    ...
    Partial Public Class AppointmentsDataTable
        ...
        Public Overloads Function AddAppointmentsRow(ByVal Type As Integer, ByVal StartDate As Date, ByVal EndDate As Date, ByVal AllDay As Boolean, ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Integer, ByVal Label As Integer, ByVal ResourceID As Integer, ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String, ByVal CustomField1 As String) As AppointmentsRow
            ...
            Dim columnValuesArray() As Object = New Object() {Nothing, Type, StartDate, EndDate, AllDay, Subject, Location, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceInfo, TimeZoneId, CustomField1}
...
Namespace SchedulerTestDataSetTableAdapters
    ...
    Partial Public Class AppointmentsTableAdapter
        ...
        Private Sub InitAdapter()
            ...
            Me._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Appointments] ([Type], [StartDate], [EndDate], [AllDay], [Subj"& _ 
                ...
                " [ReminderInfo], [RecurrenceInfo], [TimeZoneId], [CustomField1]) VALUES (@Type, "& _ 
                "@StartDate, @EndDate, @AllDay, @Subject, @Location, @Description, @Status, @Labe"& _ 
                "l, @ResourceID, @ResourceIDs, @ReminderInfo, @RecurrenceInfo, @TimeZoneId, @Cust"& _ 
                "omField1);"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, Location"& _ 
                ", Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, RecurrenceI"& _ 
                "nfo, TimeZoneId, CustomField1 FROM Appointments WHERE (UniqueID = SCOPE_IDENTITY"& _ 
                "())"
            ...
            Me._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Appointments] SET [Type] = @Type, [StartDate] = @StartDate, [EndDat"& _ 
                ...
                "RecurrenceInfo] = @RecurrenceInfo, [TimeZoneId] = @TimeZoneId, [CustomField1] = "& _ 
                "@CustomField1 WHERE (([UniqueID] = @Original_UniqueID) AND ((@IsNull_Type = 1 AN"& _ 
                "D [Type] IS NULL) OR ([Type] = @Original_Type)) AND ((@IsNull_StartDate = 1 AND "& _ 
                "[StartDate] IS NULL) OR ([StartDate] = @Original_StartDate)) AND ((@IsNull_EndDa"& _ 
                "te = 1 AND [EndDate] IS NULL) OR ([EndDate] = @Original_EndDate)) AND ((@IsNull_"& _ 
                "AllDay = 1 AND [AllDay] IS NULL) OR ([AllDay] = @Original_AllDay)) AND ((@IsNull"& _ 
                "_Subject = 1 AND [Subject] IS NULL) OR ([Subject] = @Original_Subject)) AND ((@I"& _ 
                "sNull_Location = 1 AND [Location] IS NULL) OR ([Location] = @Original_Location))"& _ 
                " AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)"& _ 
                ") AND ((@IsNull_Label = 1 AND [Label] IS NULL) OR ([Label] = @Original_Label)) A"& _ 
                "ND ((@IsNull_ResourceID = 1 AND [ResourceID] IS NULL) OR ([ResourceID] = @Origin"& _ 
                "al_ResourceID)));"&Global.Microsoft.VisualBasic.ChrW(13)&Global.Microsoft.VisualBasic.ChrW(10)&"SELECT UniqueID, Type, StartDate, EndDate, AllDay, Subject, L"& _ 
                "ocation, Description, Status, Label, ResourceID, ResourceIDs, ReminderInfo, Recu"& _ 
                "rrenceInfo, TimeZoneId, CustomField1 FROM Appointments WHERE (UniqueID = @Unique"& _ 
                "ID)"
        ...
        Private Sub InitConnection()
            ...
            Me._connection.ConnectionString = Global.Gelir_Gider_Takiip_GGT_.My.MySettings.Default.SchedulerTestConnectionString
        End Sub
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As SchedulerTestDataSet.AppointmentsDataTable) As Integer
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataSet As SchedulerTestDataSet) As Integer
        ...
        Public Overloads Overridable Function Insert(ByVal Type As Global.System.Nullable(Of Integer), ByVal StartDate As Global.System.Nullable(Of Date), ByVal EndDate As Global.System.Nullable(Of Date), ByVal AllDay As Global.System.Nullable(Of Boolean), ByVal Subject As String, ByVal Location As String, ByVal Description As String, ByVal Status As Global.System.Nullable(Of Integer), ByVal Label As Global.System.Nullable(Of Integer), ByVal ResourceID As Global.System.Nullable(Of Integer), ByVal ResourceIDs As String, ByVal ReminderInfo As String, ByVal RecurrenceInfo As String, ByVal TimeZoneId As String, ByVal CustomField1 As String) As Integer
            ...
            Else
                Me.Adapter.InsertCommand.Parameters(13).Value = CType(TimeZoneId,String)
            End If
        ...
        Public Overloads Overridable Function Update( _
            ...
            Else
                Me.Adapter.UpdateCommand.Parameters(13).Value = CType(TimeZoneId,String)
            End If
            If (CustomField1 Is Nothing) Then
    ...
    Partial Public Class ResourcesTableAdapter
        ...
        <Global.System.Diagnostics.DebuggerNonUserCodeAttribute(),  _
         Global.System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "4.0.0.0"),  _
         Global.System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")>  _
        Public Overloads Overridable Function Update(ByVal dataTable As SchedulerTestDataSet.ResourcesDataTable) As Integer
            Return Me.Adapter.Update(dataTable)
        End Function
